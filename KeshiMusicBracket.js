...
width="20%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
    `,
...
for (const item in SongCollection) {
    ...
    console.log(SongCollection[item])
}
...
const revealTopSong = () => {
    if (arrayCount >= 9) {
        ...
        winnerMsg.innerHTML = "Your favorite Keshi song is above!"
...
const revealBottomSong = () => {
    if (arrayCount >= 9) {
        let winnerMsg = document.createElement('h1')
        winnerMsg.innerHTML = "Your favorite Keshi song is below!"
        topSong.innerHTML = ""
